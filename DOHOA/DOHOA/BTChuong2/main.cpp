...
int KiemTraB(int x, int y, ToaDo2D P[], int n) {
...
//float tan_do(int alpha) {
//	return tan(alpha/180.0*M_PI);
//}
//
//float pthdgd(float a, float b, int alpha) {
//	return round(sqrt(1 / ((tan_do(alpha) / b) * (tan_do(alpha) / b) + 1 / (a * a))));
//}
